            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="card-profile__info">
                        <li class="mb-1"><strong class="text-dark mr-4"il>Password</strong>{{$customer->password}} <span></span></li>
                        <li><strong class="text-dark mr-4">Email</strong>{{$customer->email}} <span></span></li>
                    </ul>
                </div>
            </div>
        </div>
