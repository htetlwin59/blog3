            ...
            ***********************************-->
            <div id="main-wrapper">
                                    ...
                                    <div class="drop-down animated fadeIn dropdown-menu">
                                        ...
                                        <div class="dropdown-content-body">
                                            <ul>
                                                ...
                                                <li class="notification-unread">
                                                    <a href="{{asset('javascript:void()')}}">
                                                        <img class="{{asset('float-left mr-3 avatar-img')}}" src="{{asset('images/avatar/2.jpg')}}" alt="">
                                                        <div class="notification-content">
                                                ...
                                                <li>
                                                    <a href="{{asset('javascript:void()')}}">
                                                        <img class="{{asset('float-left mr-3 avatar-img')}}" src="{{asset('images/avatar/4.jpg')}}" alt="">
                                                        <div class="notification-content">
                                    ...
                                    <div class="drop-down dropdown-profile   dropdown-menu">
                                        <div class="dropdown-content-body">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{asset('email-inbox.html')}}"><i class="icon-envelope-open"></i> <span>Inbox</span> <div class="badge gradient-3 badge-pill badge-primary">3</div></a>
                                                </li>
                ...
                <div class="nk-sidebar">
                    <div class="nk-nav-scroll">
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                 <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                                    <i class="icon-screen-envelope menu-icon"></i><span class="nav-text">Post</span>
                                </a>
                                <ul aria-expanded="false">
                                    <li><a href="/posts/create">Post Add</a></li>
                                    <li><a href="/posts">Post Lists</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                ***********************************-->
                <div class="footer">
                    <div class="copyright">
                        <p>Copyright &copy; Designed & Developed by <a href="{{asset('https://themeforest.net/user/quixlab')}}">Quixlab</a> 2018</p>
                    </div>
                </div>
                <!--**********************************
                    Footer end
